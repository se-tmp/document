    ...
    \item {\large{Login}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              ...
              \item Login page
                    ...
                    \addImage{
                        imgs/specification/sign in.png
                    }{
                        Login page
                    }
              ...
              \item Signup page
                    ...
                    \addImage{
                        imgs/specification/sign up.png
                    }{
                        Sign up page
                    }
    ...
    \item {\large{Log}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              ...
              \item Log page
                    ...
                    At the Bottom of the page, there is the menu named 'Log'. When the user click the 'Log' button, He/She can see their routine logs. This application records and stores information such as the user's location, posture, and sensors by time period. Logs will be kept forever unless the user delete their account.
          \end{enumerate}
          \clearpage
    \item {\large{Device Dashboard}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              ...
              \item Add device page
                    ...
                    \addImage{
                        imgs/specification/qr code.png
                    }{
                        Add Device
                    }
                    ...
                    \addImage{
                        imgs/specification/pairing code.png
                    }{
                        Add Device without QR Code
                    }
                    \addImage{
                        imgs/specification/device connected.png
                    }{
                        Device Connected
                    }
                    \addImage{
                        imgs/specification/new device information.png
                    }{
              ...
              \item Delete device page
                    ...
                    \addImage{
                        imgs/specification/delete device.png
                    }{
                        Delete Device
                    }
    ...
    \item {\large{Routine}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              \item Routine page
                    ...
                    \addImage{
                        imgs/specification/routine.png
                    }{
                        Routine Page
                    }
              ...
              \item Create new routine
                    ...
                    \addImage{
                        imgs/specification/add routine.png
                    }{
                        Create new routine
                    }
              ...
              \item Routine Setting Page
                    ...
                    \addImage{
                        imgs/specification/routine setting.png
                    }{
                        Routine Setting
                    }
                    ...
                    \newpage
                    \addImage{
                        imgs/specification/delete routine.png
                    }{
                        Routine Delete
                    }
                    ...
                    \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
                        ...
                        \item  Posture Trigger Settings
                              ...
                              \addImage{
                                  imgs/usercase/usercase_scenario1_8.png
                              }{
                                  Posture Trigger
                              }
