    ...
    \item {\large{Device Dashboard}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              ...
              \item Add device page
                    ...
                    \addImage{
                        imgs/specification/device_add_alternative.png
                    }{
              ...
              \item Delete device page
                    ...
                    \addImage{
                        imgs/specification/device_settings_delete.png
                    }{
                        Delete Device
                    }
    ...
    \item {\large{Routine}}\\
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              \item Routine page
                    ...
                    \addImage{
                        imgs/specification/routine_main.png
                    }{
                        Routine Page
                    }
              ...
              \item Create new routine
                    ...
                    \addImage{
                        imgs/specification/routine_add.png
                    }{
                        Create new routine
                    }
              ...
              \item Routine Setting Page
                    ...
                    \addImage{
                        imgs/specification/routine_default.png
                    }{
                        Routine Setting
                    }
                    ...
                    \addImage{
                        imgs/specification/routine_delete_confirm.png
                    }{
                        Routine Delete
                    }
                    ...
                    \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
                        ...
                        \item  Posture Trigger Settings
                              ...
                              \addImage{
                                  imgs/specification/routine_settings_posture_before_select.png
                              }{
                                  Posture Trigger before select the camera
                              }
                              ...
                              \addImage{
                                  imgs/specification/routine_settings_posture_set_camera_range_overlay-1.png
                              }{
                                  Camera select page
                              }
                              \newpage
                              ...
                              \addImage{
                                  imgs/specification/routine_settings_posture_after_select.png
                              }{
                                  Posture Trigger after select the camera
                              }\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                              \newpage
    ...
    \item {\large{Behavior}}
          \begin{enumerate}[label*={\arabic*.},ref=\theenumi.\arabic*]
              ...
              \item Add Action on Routines
                    ...
                    \addImage{
                        imgs/specification/select_device.png
                    }{
                        Device select page
                    }
              ...
              \item Actions
                    ...
                    Control Device allows you to select a device, and the device has a Bulb and Switch implementation. In Time Delay, you can enter the time in minutes/second to put the time delay into the routine as much as you input. Broadcast has implemented a button that allows you to select the AI speaker you want.\\
                    \newpage
                    \addImage{
